...
def get_report_visits_yandex_metric(ids: str, date1: str, date2: str) -> str:
    """
    Получение отчёта по посещаемости сайта из Яндекс.Метрики (Reports API).
    ...
    Returns:
        pd.DataFrame: Таблица с данными по визитам, пользователям, просмотрам и качеству трафика.
...
df = get_report_visits_yandex_metric("44147844", "2025-10-01", "2025-10-21")
print(df[:200])
